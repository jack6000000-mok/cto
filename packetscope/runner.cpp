...
PacketScope::PacketScope(QWidget *parent) : QMainWindow(parent) {
    setWindowTitle("PacketScope [Proprietary] — v0.2.2");
    resize(820, 560);
...
lay->addWidget(warn);
    ...
    m_log->append(QString("PacketScope v0.2.2 — proprietary GUI. Backend: %1 (theirs).").arg(kBackend));
...
void PacketScope::showAbout() {
    QMessageBox::about(this, "About PacketScope",
        "PacketScope v0.2.2 — © 2026 oday, All Rights Reserved (Proprietary).\n\n"
