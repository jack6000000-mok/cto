...
HashBench::HashBench(QWidget *parent) : QMainWindow(parent) {
    setWindowTitle("HashBench [Proprietary] — v0.2.2");
    resize(820, 560);
...
lay->addWidget(warn);
    ...
    m_log->append(QString("HashBench v0.2.2 — proprietary GUI. Backend: %1 (theirs).").arg(kBackend));
...
void HashBench::showAbout() {
    QMessageBox::about(this, "About HashBench",
        "HashBench v0.2.2 — © 2026 oday, All Rights Reserved (Proprietary).\n\n"
