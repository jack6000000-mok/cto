...
AirAudit::AirAudit(QWidget *parent) : QMainWindow(parent) {
    setWindowTitle("AirAudit [Proprietary] — v0.1.0");
    resize(820, 560);
...
lay->addWidget(warn);
    ...
    m_log->append(QString("AirAudit v0.1.0 — proprietary GUI. Backend: %1 (theirs).").arg(kBackend));
...
void AirAudit::showAbout() {
    QMessageBox::about(this, "About AirAudit",
        "AirAudit v0.1.0 — © 2026 oday, All Rights Reserved (Proprietary).\n\n"
