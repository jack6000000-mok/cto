...
SmbDrop::SmbDrop(QWidget *parent) : QMainWindow(parent) {
    setWindowTitle("SmbDrop [Proprietary] — v0.1.1");
    resize(820, 560);
...
lay->addWidget(warn);
    ...
    m_log->append(QString("SmbDrop v0.1.1 — proprietary GUI. Backend: %1 (theirs).").arg(kBackend));
...
void SmbDrop::showAbout() {
    QMessageBox::about(this, "About SmbDrop",
        "SmbDrop v0.1.1 — © 2026 oday, All Rights Reserved (Proprietary).\n\n"
