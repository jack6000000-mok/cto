...
CredAudit::CredAudit(QWidget *parent) : QMainWindow(parent) {
    setWindowTitle("CredAudit [Proprietary] — v0.1.0");
    resize(820, 560);
...
lay->addWidget(warn);
    ...
    m_log->append(QString("CredAudit v0.1.0 — proprietary GUI. Backend: %1 (theirs).").arg(kBackend));
...
void CredAudit::showAbout() {
    QMessageBox::about(this, "About CredAudit",
        "CredAudit v0.1.0 — © 2026 oday, All Rights Reserved (Proprietary).\n\n"
