...
PortScope::PortScope(QWidget *parent) : QMainWindow(parent) {
    setWindowTitle("PortScope [Proprietary] — v0.2.2");
    resize(820, 560);
    ...
    m_log->append(QString("PortScope v0.2.2 — proprietary GUI. Backend: %1 (theirs).").arg(kBackend));
...
void PortScope::showAbout() {
    QMessageBox::about(this, "About PortScope",
        "PortScope v0.2.2 — © 2026 oday, All Rights Reserved (Proprietary).\n\n"
