...
VulnLaunch::VulnLaunch(QWidget *parent) : QMainWindow(parent) {
    setWindowTitle("VulnLaunch [Proprietary] — v0.2.2");
    resize(820, 560);
...
lay->addWidget(warn);
    ...
    m_log->append(QString("VulnLaunch v0.2.2 — proprietary GUI. Backend: %1 (theirs).").arg(kBackend));
...
void VulnLaunch::showAbout() {
    QMessageBox::about(this, "About VulnLaunch",
        "VulnLaunch v0.2.2 — © 2026 oday, All Rights Reserved (Proprietary).\n\n"
