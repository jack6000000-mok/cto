...
VenomForge::VenomForge(QWidget *parent) : QMainWindow(parent) {
    setWindowTitle("VenomForge [Proprietary] — v0.1.0");
    resize(820, 560);
...
lay->addWidget(warn);
    ...
    m_log->append(QString("VenomForge v0.1.0 — proprietary GUI. Backend: %1 (theirs).").arg(kBackend));
...
void VenomForge::showAbout() {
    QMessageBox::about(this, "About VenomForge",
        "VenomForge v0.1.0 — © 2026 oday, All Rights Reserved (Proprietary).\n\n"
