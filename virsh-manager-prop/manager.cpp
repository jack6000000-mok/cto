...
VirshManager::VirshManager(QWidget *parent) : QMainWindow(parent) {
    setWindowTitle("VirshManager [Proprietary] — v0.2.0");
    resize(860, 600);
    ...
    m_log->append("VirshManager v0.2.0 — proprietary. Uses system virsh; Qt under LGPL.");
...
void VirshManager::showAbout() {
    QMessageBox::about(this, "About VirshManager",
        "VirshManager v0.2.0 — © 2026 oday, All Rights Reserved (Proprietary).\n\n"
